...
public class UserInterface {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("APLIKASI SIMPLE CRUD TEXT DATABASE");
        while (true){
            tampilkanMenu();
            ...
            switch (pilihan){
                case "C":
                    ...
                    break;
                case "R":
                    System.out.println("INFO: Anda memilih meenu Read");
                    db.view();
                    break;
                case "U":
                    ...
                    if (index >= 0){
                        System.out.println("Anda akan meng_update data "+db.getData().get(index));
                        System.out.println("----------------------------------------------");
                        System.out.println("INPUT  DATA  BARU");
                        System.out.print("NIM            : ");
                        nim = sc.nextLine();
                ...
                case "D":
                    ...
                    if (index>=0){
                        ...
                        if (pilihan.equalsIgnoreCase("Y")){
                            ...
                            if (status==true){
                                System.out.println("DATA BERHASIL DUHAPUS");
                            }else {
